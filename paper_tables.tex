...
% Table 5: Per-Target Label Transfer Results
\begin{table}[h]
\centering
\caption{Label transfer performance by target study. SCimilarity outperforms traditional methods consistently across all targets, with particularly strong performance on beneyto-calabuig-2023 (ARI=0.852). Reference: van\_galen\_2019 (23,344 cells).}
